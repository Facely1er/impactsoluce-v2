  ...
  const securityFeatures = [
    ...
    },
    {
      ...
      details: [
        ...
        t('NIST Cybersecurity Framework alignment'),
              ...
              <CardContent>
                ...
                <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    <strong>{t('Security Incident Reporting')}:</strong> {t('If you discover a security vulnerability or incident, please report it immediately to security@impactsoluce.com. We take all security reports seriously and will respond within 24 hours.')}
                  </p>
                </div>
              </CardContent>
            </Card>
