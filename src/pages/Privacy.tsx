            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  {t('ImpactSoluce™ by ERMITS ("we," "our," or "us") is committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our ESG platform and services.')}
                </p>
            ...
            <Card className="mt-8">
              ...
              <CardContent>
                ...
                <div className="space-y-2 text-gray-600 dark:text-gray-300">
                  <p><strong>{t('Email')}:</strong> privacy@impactsoluce.com</p>
                  <p><strong>{t('Address')}:</strong> {t('ERMITS, ImpactSoluce Division')}</p>
                  <p><strong>{t('Phone')}:</strong> {t('Contact via email')}</p>
                </div>
                <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    <strong>{t('Data Protection Officer')}:</strong> {t('For EU residents, you can contact our Data Protection Officer at dpo@impactsoluce.com for any privacy-related inquiries or to exercise your rights under GDPR.')}
                  </p>
                </div>
              </CardContent>
            </Card>
