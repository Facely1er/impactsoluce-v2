...
export default function Pricing() {
  ...
  const plans = [
    ...
    {
      name: t('Professional'),
      description: t('Comprehensive ESG management for growing organizations'),
      icon: Building,
      price: isAnnual ? 799 : 899,
      period: isAnnual ? t('per month, billed annually') : t('per month'),
      features: [
        t('Advanced ESG assessments'),
        t('Up to 500 employees'),
        t('Custom reporting & dashboards'),
        t('Priority support'),
        t('Advanced carbon management'),
        t('Multiple framework support'),
        t('Technology dependency analysis'),
        t('Stakeholder collaboration tools'),
        t('Data export & API access'),
      ],
      limitations: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              {t('Choose the plan that fits your organization\'s ESG needs. All plans include core features with no hidden fees.')}
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-primary-100 mb-8">
              {t('Start your free trial today and see how ESGSoluce can transform your sustainability reporting.')}
            </p>
