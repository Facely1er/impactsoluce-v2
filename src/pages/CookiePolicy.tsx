          ...
          <div className="max-w-4xl mx-auto">
            <Card className="mb-8">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  {t('ImpactSoluce™ by ERMITS uses cookies to enhance your browsing experience, analyze site traffic, and personalize content. This policy explains what cookies we use, why we use them, and how you can manage your cookie preferences.')}
                </p>
