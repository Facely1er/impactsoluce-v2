            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  {t('These Terms of Service ("Terms") govern your use of ESGSoluce\'s platform and services. These Terms apply to all visitors, users, and others who access or use our service.')}
                </p>
            ...
            <div className="space-y-8 mt-8">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4 text-gray-600 dark:text-gray-300">
                    <p>
                      {t('The service and its original content, features, and functionality are and will remain the exclusive property of ESGSoluce and its licensors. The service is protected by copyright, trademark, and other laws.')}
                    </p>
                    <p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4 text-gray-600 dark:text-gray-300">
                    <p>
                      {t('These Terms shall be interpreted and governed by the laws of the jurisdiction in which ESGSoluce is incorporated, without regard to its conflict of law provisions.')}
                    </p>
                    <p>
            ...
            <Card className="mt-8">
              ...
              <CardContent>
                ...
                <div className="space-y-2 text-gray-600 dark:text-gray-300">
                  <p><strong>{t('Email')}:</strong> legal@esgsoluce.com</p>
