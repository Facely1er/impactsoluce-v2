...
export default function Header() {
  ...
  const assessmentNavigation = [
    { name: t('Assessment'), href: '/assessment', icon: ClipboardList },
    { name: t('Standards Mapping'), href: '/standards-mapping', icon: Map },
    { name: t('Reports'), href: '/assessment/history', icon: FileText },
  ];

  // Sustainability section
  const sustainabilityNavigation = [
    { name: t('Tech Dependencies'), href: '/tech-dependency', icon: Network },
    { name: t('Carbon Management'), href: '/carbon-management', icon: Zap },
  ];
        ...
        <span className="block text-xs text-gray-600 dark:text-gray-400 font-normal">by ERMITS</span>
          ...
          <nav className="hidden md:flex space-x-1">
            ...
            <div className="relative group mr-4">
              ...
              <div className="absolute left-0 mt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out z-50">
